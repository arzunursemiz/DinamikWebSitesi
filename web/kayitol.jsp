...
<main class="hoc container clear fa-align-center">
  ...
  <div class="group fa-align-center">
    <div class="one_half first">
      <h5 class="heading font-x3">Kayıt Ol</h5>
        <form action="KayitOl" method="post" >
            <input type="text" name="ad_soyad" placeholder="Adınız Soyadınız" required=""><br>
            ...
            <label>Görevinizi Seçin</label>
          <select name="rol" class="center" required="">
            <option>Yazar</option>
          </select>
          <br>
          <br>
